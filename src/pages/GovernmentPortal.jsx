                ...
                {pendingRequests.length === 0 ? (
                    ...
                    <div className="grid gap-8">
                        {pendingRequests.map((req) => (
                            <div key={req.id} className="bg-zinc-950 border border-white/5 rounded-[50px] overflow-hidden hover:border-blue-500/30 transition-all duration-500 shadow-3xl">
