...
const Blockchain = () => {
  ...
  return (
    ...
    <section className="relative flex flex-col items-center px-4 md:px-8 py-16 min-h-screen bg-[#000000] text-white overflow-hidden">
      
      {/* 🔥 SHOCKING GRID BACKGROUND START (Matches Home.jsx) */}
