  ...
  return (
    <>
      ...
      <section className="relative flex flex-col items-center justify-center px-8 pt-16 pb-10 overflow-hidden min-h-[90vh] bg-[#000000]">
        ...
        {/* 🔥 NEW BACKGROUND START (Moving Grid + Aurora) */}
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
            <div className="absolute top-[-10%] left-[20%] w-[60%] h-[500px] bg-gradient-to-b from-purple-900 via-fuchsia-900 to-transparent opacity-20 blur-[120px] rounded-full animate-pulse-slow"></div>
        ...
        <div className="relative max-w-6xl w-full grid md:grid-cols-2 gap-12 items-center mb-16 z-10">
          ...
          <div>
            ...
            <p className="text-sm font-semibold tracking-[0.2em] text-cyan-400 mb-3">BLOCKCHAIN POWERED REAL ESTATE</p>
            ...
            <p className="text-gray-300 text-sm md:text-base mb-6">Verify ownership and track property records instantly.</p>
          ...
          <div className="hidden md:flex justify-center relative">
             <div className="relative w-80 bg-black/80 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl overflow-hidden group">
                ...
                <div className="flex items-center justify-between mb-6 border-b border-white/10 pb-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div><p className="text-white text-sm font-semibold">Digital Deed</p><p className="text-[10px] text-gray-500">ERC-721 Standard</p></div>
                    </div>
                    <div className="h-2 w-2 rounded-full bg-green-500 animate-pulse"></div>
                </div>
                <div className="space-y-4 font-mono">
                    <div className="bg-zinc-900/50 p-3 rounded border border-white/5"><p className="text-[10px] text-gray-500 mb-1">PROPERTY HASH</p><p className="text-cyan-400 text-xs truncate">{scannedHash}</p></div>
                    <div className="grid grid-cols-2 gap-3">
                        <div className="bg-zinc-900/50 p-3 rounded border border-white/5"><p className="text-[10px] text-gray-500 mb-1">OWNER</p><p className="text-gray-300 text-xs">Rohit Y.</p></div>
                        <div className="bg-zinc-900/50 p-3 rounded border border-white/5"><p className="text-[10px] text-gray-500 mb-1">LOCATION</p><p className="text-gray-300 text-xs">Bihar, IN</p></div>
                    </div>
                </div>
                <div className="mt-6 pt-3 border-t border-white/5 flex justify-between text-[10px] text-gray-500"><span>Status: <span className="text-green-400">Verified</span></span><span>Block: #8921..</span></div>
             </div>
          </div>
        </div>
