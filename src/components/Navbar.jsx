...
const Navbar = () => {
  ...
  return (
    <nav className="w-full px-6 lg:px-8 py-4 flex items-center justify-between bg-black/10 backdrop-blur-lg border-b border-white/10 sticky top-0 z-[100]">
      ...
      {!isAdminPage ? (
        <div className="hidden lg:flex items-center gap-8">
            ...
            <NavLink to="/giftOwnership" className={linkClasses}>GiftOwnership</NavLink>
      ...
      <div className="hidden lg:flex items-center gap-4">
        ...
        {isWalletConnected ? (
          ...
          <button
            ...
            className="px-5 py-2 rounded-full bg-blue-600 hover:bg-cyan-500 text-white text-sm font-bold transition-all shadow-lg shadow-cyan-500/20"
          >
            Connect Wallet
          </button>
        )}
      ...
      <div className="flex lg:hidden items-center gap-4 z-50">
        {!isWalletConnected && !isUserLoggedIn && (
            <button onClick={() => navigate("/login")} className="px-4 py-1.5 rounded-full bg-blue-600 text-white text-xs font-bold">
                Login
            </button>
        )}
        ...
        <div className="px-6 py-8 flex flex-col space-y-4 max-h-[85vh] overflow-y-auto">
            ...
            {!isAdminPage && (
                <div className="flex flex-col space-y-2">
                    ...
                    <NavLink to="/giftOwnership" className={mobileLinkClasses} onClick={() => setIsMenuOpen(false)}>GiftOwnership</NavLink>
            ...
            {isUserLoggedIn ? (
                ...
                <button onClick={() => { navigate("/login"); setIsMenuOpen(false); }} className="w-full py-4 mt-2 rounded-xl bg-blue-500/65 text-white font-bold shadow-lg">
