            ...
            <section className="relative flex flex-col items-center justify-center px-8 pt-5 pb-10 overflow-hidden min-h-screen bg-[#FFFDD0]">
                ...
                <div className="relative max-w-4xl w-full flex flex-col items-center text-center z-10 mb-16 px-4">
                    ...
                    <div className="mb-10">
                        ...
                        <h1 className="text-4xl md:text-6xl font-black mb-6 text-white leading-tight uppercase italic tracking-tighter">
                            The Smartest Way to Choose
                            <span className="block mt-2 pb-1 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent">
                                Verify &amp; Own Land
                            </span>
                        </h1>
